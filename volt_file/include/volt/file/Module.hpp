...
namespace volt::file
{
    ...
    public:
        ...
        inline std::vector<JSONData> const &GetAutoloadJSONs() const
        {
        ...
        inline std::vector<std::string> const &GetDependencies() const
        {
        ...
        inline std::string const &GetTargetVersion() const
        {
        ...
        inline std::string const &GetRepository() const
        {
            return this->repository;
        }

        inline std::vector<std::string> const &GetLoadAfter() const
        {
